<template>
  <v-div>
    ...
    <v-row align="center">
      <v-container style="width: 40%; min-width: 400px; max-width: 650px">
        <list-postulants></list-postulants>
      </v-container>
      <v-col cols="12" sm="6">
        <div class="text-center">
          <div class="my-2">
            <v-btn color="#1955AE" dark style="width: 50%; max-width: 260px; min-width: 260px">MODIFICAR DATOS</v-btn>
          </div>
          <div class="my-2">
            <v-btn color="#1955AE" dark style="width: 50%; max-width: 260px; min-width: 260px">ENVIAR MENSAJE A TODOS</v-btn>
          </div>
          <div class="my-2">
            <v-btn color="#1955AE" to="/create-interview" dark style="width: 50%; max-width: 260px; min-width: 260px">CREAR ENTREVISTA</v-btn>
          </div>
        </div>
      </v-col>
    </v-row>
    ...
    <v-container fluid class="text-center">
      <v-btn to="/home-employer" class="white--text" depressed color="red" style="border-radius: 10px" x-large>Cerrar Postulaciones</v-btn>
    </v-container>
...
<script>
import ListPostulants from "./list-postulants";
